    ...
    <main className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="relative mx-auto w-full max-w-3xl px-6 pt-10 pb-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              ...
              {isAdmin && (
                <Link
                  href="/admin/regolamento"
                  className="rounded-2xl border border-yellow-300/25 bg-yellow-300/10 px-4 py-2 text-sm font-semibold text-yellow-100 hover:bg-yellow-300/15"
                >
                  Modifica (solo Frodo) →
                </Link>
              )}
      ...
      <div className="mx-auto w-full max-w-3xl px-6 pb-14 space-y-5">
        ...
        <Card title="Bonus & Malus" icon="⚡">
          ...
          <div className="mt-3 rounded-2xl border border-white/10 bg-black/30 p-4">
            <div className="text-white/70 text-sm">👑 Admin supremo</div>
            <div className="text-lg font-extrabold">Instrutor Frodo</div>
        ...
        <section className="rounded-[28px] border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-6">
          ...
          <p className="mt-4 text-xs text-white/50">
            *Questo regolamento è ufficiale finché l’admin e gli ideatori non cambiano idea.
          </p>
        </section>
      </div>
    </main>
